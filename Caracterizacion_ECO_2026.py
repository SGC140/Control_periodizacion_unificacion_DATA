...
DATASET_ID = "EFE_2026"
TABLE_ID   =  "ECOPLUS_2026_Caracterizacion"
...
Hoja_caracterizacion = sheet.worksheet("Caracterización")
Datos = Hoja_caracterizacion.get_all_values()
...
DF = DF.dropna(subset=['Número de identificación'])
